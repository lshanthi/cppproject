...
<div class="bg-light py-3">
    ...
    <div class="site-section">
      ...
      <div class="container">
      <sf:form action="/category/search" method="post" modelAttribute="form">
        <div class="row mb-5">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="/category/getImage/<c:out value='${ct.id}'/>" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">${ct.name}</h2>
                    </td>
                    <td>${ct.description}</td>
                    <td><a href="/category?id=${ct.id}" class="btn btn-primary btn-sm">Edit</a></td>
                    <td><a href="/category/search?cidd=${ct.id}&operation=Delete" class="btn btn-primary btn-sm">X</a></td>
                  </tr>
