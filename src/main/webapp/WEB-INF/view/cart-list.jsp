...
<%@page import="in.co.mobile.store.util.HTMLUtility"%>
...
<div class="bg-light py-3">
    ...
    <div class="site-section">
      ...
      <div class="container">
        <sf:form action="/cart/update" method="post" modelAttribute="form">
        <div class="row mb-5">
                ...
                <c:forEach items="${list}" var="ct" varStatus="cs">
                  <tr>
                    <td class="product-thumbnail">
                      <img src="/prod/getImage/<c:out value='${ct.productId}'/>" alt="Image" class="img-fluid">
                    </td>
                    ...
                    <td><a href="/cart?crId=${ct.id}&operation=Delete" class="btn btn-primary btn-sm">X</a></td>
                 ...
                 <td ><a href="/bookProd" class="btn btn-primary btn-sm">Book</a></td>
                 </tr>
                </tbody>
              </table>
            </div>
