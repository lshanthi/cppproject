...
<div class="bg-light py-3">
	 ...
	 <sf:form action="/prod/home/search" method="post" modelAttribute="form">
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  ...
                  <%if(userbean!=null){ %>	
                    ...
                    <a href="/prod/detail?pid=${pd.id}"><img src="/prod/getImage/<c:out value='${pd.id}'/>" alt="Image placeholder" class="img-fluid"></a>
                 	<%}else{ %>
                 	<img src="/prod/getImage/<c:out value='${pd.id}'/>" alt="Image placeholder" class="img-fluid">
                 	<%} %>
                 	<%}else{ %>
                 	<a href="/login?pid=${pd.id}"><img src="/prod/getImage/<c:out value='${pd.id}'/>" alt="Image placeholder" class="img-fluid"></a>
                 	<%} %>
                  </figure>
